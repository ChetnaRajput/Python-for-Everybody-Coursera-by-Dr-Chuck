...
Given the Library.xml file to be used for this assignment. You can export your
own tracks from iTunes and create a database, but for the database that you
...
The expected result of the modified query on your database is: (shown here as a
simple HTML table with titles)
