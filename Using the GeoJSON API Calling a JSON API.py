...
In this assignment you will write a Python program that will prompt for a location,
...
no rate limit so you can test as often as you like. If you visit the URL with no
...
Retrieved 2129 characters

ChIJM58q-cHs9EcRTAlpCvXs1xk
Enter location:
"""
